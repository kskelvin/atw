...
--
-- Table structure for table `anggota_departemen_grup`
--

CREATE TABLE `anggota_departemen_grup` (
  `id` int(11) NOT NULL,
  `departemen_id` int(11) NOT NULL,
  `member_departemen` int(11) NOT NULL,
...
--
-- Table structure for table `anggota_diskusi`
--

CREATE TABLE `anggota_diskusi` (
  `id` int(11) NOT NULL,
  `diskusi_id` int(11) NOT NULL,
  `member_diskusi` int(11) NOT NULL,
...
--
-- Table structure for table `departemen_grup`
--
...
CREATE TABLE `departemen_grup` (
  ...
  `pimpinan_dep` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `departemen_grup`
--

INSERT INTO `departemen_grup` (`id`, `nama_dep`, `role_dep`, `pimpinan_dep`) VALUES
(1, 'keuangan', 0, 75),
(4, 'agama', 0, 13);
...
CREATE TABLE `diskusi` (
  ...
  `pembuat_diskusi` int(20) NOT NULL,
  `dep_id` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `lihat_agenda`
--
...
--
-- Table structure for table `lihat_dokumen`
--
...
(13, 'ks', 'kelvin', 0, '../profile/ksq.jpg'),
(74, 'ting', '123', 1, '../profile/tings.png'),
...
--
-- Indexes for table `anggota_departemen_grup`
--
ALTER TABLE `anggota_departemen_grup`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `anggota_diskusi`
--
ALTER TABLE `anggota_diskusi`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `diskusi`
  ADD PRIMARY KEY (`id`),
  ADD KEY `member_user` (`pembuat_diskusi`),
  ADD KEY `dep_id` (`dep_id`);
...
--
-- AUTO_INCREMENT for table `anggota_departemen_grup`
--
ALTER TABLE `anggota_departemen_grup`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `anggota_diskusi`
--
ALTER TABLE `anggota_diskusi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- Constraints for table `departemen_grup`
--
ALTER TABLE `departemen_grup`
  ADD CONSTRAINT `departemen_grup_ibfk_1` FOREIGN KEY (`pimpinan_dep`) REFERENCES `user` (`id`);

--
-- Constraints for table `diskusi`
--
ALTER TABLE `diskusi`
  ADD CONSTRAINT `diskusi_ibfk_1` FOREIGN KEY (`pembuat_diskusi`) REFERENCES `user` (`id`),
...
--
-- Constraints for table `lihat_agenda`
--
ALTER TABLE `lihat_agenda`
...
--
-- Constraints for table `lihat_dokumen`
--
ALTER TABLE `lihat_dokumen`
